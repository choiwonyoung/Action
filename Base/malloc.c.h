...
#pragma warning( push )
#pragma warning( disable: 4312 ) // DWORD to long conversion warning
...
/*
  ...
  the ones for trees, which are very long but have very int16 typical
